...
[assembly: Dependency(typeof(PrimeNumberService))]
#endregion

namespace PrimeNumbers.Services
{
    public class PrimeNumberService : IPrimeNumerService  //IPrimeNumerService is used only for DI
    {
